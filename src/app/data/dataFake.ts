export const dataFake = [
  {
    "id": "1",
    "photo": "./assets/crudJS1.png",
    "title": "What is a CRUD and how to build in JavaScript",
    "category": "technology",
  },
  {
    "id": "2",
    "photo": "./assets/poo1.png",
    "title": "Programação Orientada a Objetos em Java",
    "category": "technology",
  },
  {
    "id": "3",
    "photo": "./assets/http1.png",
    "title": "O que é uma Requisição HTTP e método fetch",
    "category": "technology",
  },
  {
    "id": "4",
  ...
  {
    "id": "6",
    "photo": "./assets/gitGithub.png",
    "title": "O que são Git e GitHub e para que servem?",
    "category": "technology",
  },
  {
    "id": "7",
